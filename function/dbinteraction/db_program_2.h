...
private:
    ...
    QJsonObject mobilePlayProgram(QJsonObject &obj);
    QJsonObject mobileStopProgram(QJsonObject &obj);
    QJsonObject mobilePauseProgram(QJsonObject &obj);
    QJsonObject mobileRestoreProgram(QJsonObject &obj);
};
