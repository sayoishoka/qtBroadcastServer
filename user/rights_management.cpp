...
QJsonObject Rights_management::addPms(QJsonObject &obj)
{
    ...
    QSqlQuery query2 = BroadcastMain::getData_Sheet("INSERT INTO permission (role_no,func_no) VALUES ('"+roleNo+"','"+func+"')");
    QJsonObject requestjson;
...
QJsonObject Rights_management::removePms(QJsonObject &obj)
{
    ...
    QSqlQuery query2 = BroadcastMain::getData_Sheet("DELETE FROM permission WHERE role_no='"+roleNo+"' AND func_no='"+func+"'");
    QJsonObject requestjson;
